  ...
  return (
    <div>
      <div className="dropdown">
        ...
        <div className="dropdown-menu dropdown-menu-sm-end dropdown-card card-dropdown-filter-centered" aria-labelledby="FilterDropdown" style={{ minWidth: '52rem' }}
        >
          <div className="card">
            ...
            <div className="card-body">
              <form>
                <div className="row">
                  ...
                  <div className="col-sm mb-4">
                    <small className="text-cap text-body">Níveis</small>
                  ...
                  <div className="col-sm mb-4">
                    <small className="text-cap text-body">Anos</small>
