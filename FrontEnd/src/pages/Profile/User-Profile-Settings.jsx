...
import { profile, getAllData, profileUpdate } from '../../api/deviceAPI';
    ...
    const fetchUserProfile = async () => {
      try {
        ...
        setFormData({
          ...
          group: res.profile.idGroup,
          school: res.profile.idSchool,
        });
      } catch (err) {
        console.error(err);
      }
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="col-sm-9">
                              ...
                              >
                                <option disabled value="">
                                  {userProfile.nameGroup || "É preciso escolher"}
                                </option>
                          ...
                          <div className="row mb-4">
                            ...
                            <div className="col-sm-9">
                              ...
                              >
                                <option disabled value="">
                                  {userProfile.nameSchool || "É preciso escolher"}
                                </option>
                                <option disabled>-- {t('text_info_settings_1')} --</option>
