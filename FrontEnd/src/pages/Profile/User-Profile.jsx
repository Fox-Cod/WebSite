...
import { profile, activity, resources } from '../../api/deviceAPI';
                  ...
                  <div className="js-sticky-block card mb-3 mb-lg-5" style={{ maxHeight: '800px' }}>
                    ...
                    <div className="card-body overflow-auto">
                      <ul className="list-unstyled list-py-2 text-dark mb-0">
                        {userProfile.nameSchool || userProfile.nameGroup ? (
                          <div className='list-unstyled list-py-2 text-dark mb-0'>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column' }}>
                              {teams && teams.length > 0 ? (
                                ...
                                <div>Equipes não encontrados</div>
                              )}
                            </div>
                          </div>
                        ) : (
                          <p>Não foi verificado!</p>
                        )}
                      </ul>
                    </div>
                  </div>
                      ...
                      <ul className="list-unstyled list-py-2 text-dark mb-0">
                        ...
                        {favoritesActivity.length > 0 ? (
                          favoritesActivity.map(favId => {
                            ...
                            ) : <small className='text-body'>Ainda está vazio.</small>;
                          })
                        ) : (
